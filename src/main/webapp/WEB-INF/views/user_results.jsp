...
<html>
<head>
    <title>Kalkulator PV | ${user.login} - wyniki kalkulacji inwestycji</title>
        ...
        <div class="card-body">
            <table border="2" class="table table-striped table-dark table-hover  table-borderless">
                ...
                <tr class="font-weight-bold text-center">
                    <td colspan="2">
                Inwestycja: ${investmentScenario.name}
                    </td>
                </tr>
                </thead>
                <tr>
            ...
            <script type="text/javascript">
                document.getElementById("editButton").onclick = function () {
                    location.href = "/user/edit/"+${investmentScenario.id};
                };
            </script>
            <button class="btn btn-outline-success my-2 my-sm-0 btn-sm" id="showListButton">Pokaż moje inwestycje
            </button>
            <script type="text/javascript">
                document.getElementById("showListButton").onclick = function () {
                    location.href = "/user/investments";
                };
            </script>
        </div>
    </div>
